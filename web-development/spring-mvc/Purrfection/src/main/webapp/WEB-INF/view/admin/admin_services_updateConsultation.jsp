      ...
      <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
              ...
              <div class="container-fluid">
                  ...
                  <!-- Page Heading -->
                  <h1 class="h3 mb-2 text-gray-800">Update Consultation</h1>

                  
                  <form:form action="../admin/admin_processUpdateConsultation" modelAttribute="consultation">
                      <form:hidden path="consultation_id" class="form-control"/>
                      <form:hidden path="pet_id" class="form-control"/>

                      <div class="form-group">
                          <form:label path="consul_date">Consultation Date</form:label>
                          <form:input type="date" path="consul_date" class="form-control"/>
                      </div>
                      <div class="form-group">
                          <form:label path="findings"> Findings </form:label>
                          <form:input path="findings" class="form-control"/>
                      </div>
                      <div class="form-group">
                          <form:label path="recommendations"> Recommendations </form:label>
                          <form:input path="recommendations" class="form-control"/>
                      </div>
                    <input type="submit" value="Update Consultation" class="btn btn-primary">
                  </form:form>
              </div>
              <!-- /.container-fluid -->
