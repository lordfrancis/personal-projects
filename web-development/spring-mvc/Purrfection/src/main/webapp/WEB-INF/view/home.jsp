    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="getstarted scrollto" href="login">Book an Appointment</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h2>Purrfection provides the happiest, healthiest puppies to Bohol. From breed selection, pet training and pet products, Purrfection is your goto puppy expert!</h2>
          <div>
            <a href="login" class="btn-get-started scrollto">Book an Appointment</a>
          </div>
        </div>
