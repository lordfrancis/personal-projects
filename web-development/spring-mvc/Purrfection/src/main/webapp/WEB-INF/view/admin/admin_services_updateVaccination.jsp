      ...
      <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
              ...
              <div class="container-fluid">
                  ...
                  <!-- Page Heading -->
                  <h1 class="h3 mb-2 text-gray-800">Update Vaccination</h1>

                  
                  <form:form action="../admin/admin_processUpdateVaccination" modelAttribute="vaccination">
                      <form:hidden path="vaccination_id" class="form-control"/>
                    ...
                    <input type="submit" value="Update Vaccination" class="btn btn-primary">
                  </form:form>
              </div>
              <!-- /.container-fluid -->
