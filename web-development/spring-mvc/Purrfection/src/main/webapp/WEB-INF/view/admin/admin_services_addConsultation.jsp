      ...
      <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div id="content">
              ...
              <div class="container-fluid">
                  ...
                  <!-- Page Heading -->
                  <h1 class="h3 mb-2 text-gray-800">Add Consultation</h1>

                  
                  <form:form action="../admin/admin_processAddConsultation" modelAttribute="consultation">
                    ...
                    <input type="submit" value="Add Consultation" class="btn btn-primary">
                  </form:form>
              </div>
              <!-- /.container-fluid -->
