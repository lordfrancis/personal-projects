    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="../user/user_myAppointments">My Appointments</a></li>
  ...
  <div class="container mt-10">
    ...
    <table id="pet_table">
      <thead>
                ...
                <tbody>
                <c:forEach items="${appointmentList}" var="aptmt">
                  <tr>
                    <td>${aptmt.appointment_id}</td>
                    <td>${aptmt.date}</td>
                    <td>${aptmt.time_slot}</td>
                    <td>${aptmt.type}</td>
                    <td>${aptmt.status}</td>
                  </tr>
